...
CREATE INDEX ton_wallets_address_index
    ON payments.ton_wallets (address);

CREATE INDEX ton_wallets_type_index
    ON payments.ton_wallets (type);

CREATE INDEX ton_wallets_user_id_index
...
CREATE INDEX jetton_wallets_subwallet_id_index
...
CREATE INDEX internal_incomes_deposit_address_index
...
CREATE INDEX external_withdrawals_expired_at_index
    ON payments.external_withdrawals (expired_at);

CREATE INDEX external_withdrawals_msg_uuid_index
    ON payments.external_withdrawals (msg_uuid);

CREATE INDEX external_withdrawals_address_index
    ON payments.external_withdrawals (address);

CREATE INDEX external_withdrawals_query_id_index
...
CREATE INDEX withdrawal_requests_user_id_index
    ON payments.withdrawal_requests (user_id);

CREATE INDEX withdrawal_requests_user_query_id_index
    ON payments.withdrawal_requests (user_query_id);

CREATE INDEX withdrawal_requests_dest_address_index
...
CREATE INDEX external_incomes_deposit_address_index
...
CREATE INDEX block_data_seqno_index
...
CREATE INDEX internal_withdrawals_from_address_index
    ON payments.internal_withdrawals (from_address);

CREATE INDEX internal_withdrawals_since_lt_index
    ON payments.internal_withdrawals (since_lt);

CREATE INDEX internal_withdrawals_expired_at_index
