...
| `PROOF_CHECK_ENABLED`  | enable proof check for untrusted node                                                                                                                                                                                                                                                                                                                                         |
| `NETWORK_CONFIG_URL`   | url to network config file, example: for testnet `https://ton.org/testnet-global.config.json`, for mainnet `https://ton.org/global.config.json`                                                                                                                                                                                                                               |
